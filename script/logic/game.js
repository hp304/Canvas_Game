...
class Game {
    ...
    init() {
        ...
        this.crates = new Crate([this.config.CRATE_SRC]);
        this.ground = new Hitbox(0,40, this.canvas.width, 150);
        this.player = new Player(this.config.PLAYER_SRC, this.playerNickname, this.enemy, this.crates);
